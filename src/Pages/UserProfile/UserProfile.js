   ...
   return (
      ...
      <div className="md:px-10 py-5 w-full ">
         ...
         <table className="text-xs  table table-zebra w-full mt-10">
            ...
            <tbody>               
               {
                  loans.map((loan, idx) => <tr className="text-center " key={loan._id}>
                     <td>{idx + 1}</td>
                     <td>{loan.date}</td>
                     <td>{loan.loan}</td>
                     <td>{loan.Interest}%</td>
                     ...
                     <td>{loan?.status=== "approved" ?
                      <span className="px-2 py-1 bg-green-500 rounded-lg text-primary  font-bold capitalize">approved</span> : 
                      <span className="px-2 py-1 bg-secondary rounded-lg text-white   font-bold capitalize ">pending</span>
