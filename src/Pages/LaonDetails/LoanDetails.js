...
const LoanDetails = ({ emiDetails, setEmiDetails }) => {
   ...
   const handleSubmit = (event) => {
      ...
      fetch(`https://safe-loan-server.vercel.app/loans`, {
         method: "post",
         headers: {
   ...
   return (
      <section className="mt-20 flex items-center justify-center ">
         <form
            ...
            className="text-accent capitalize  bg-primary p-5 py-14 rounded-lg flex gap-4 flex-col w-[400px]  md:w-full lg:w-[85%] myForm"
         >
            ...
            <div className="flex items-center justify-center  gap-5 mt-3">
               ...
               <button
                  ...
                  className="rounded-lg   hover:scale-75 hover:text-primary duration-1000 transition-all px-5 py-2 bg-secondary"
               >
                  Cancel
               </button>
            </div>
