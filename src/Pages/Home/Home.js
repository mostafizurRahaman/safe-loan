...
const Home = () => {
   return (
      <div className="flex md:flex-row flex-col-reverse  items-center justify-center   px-5 md:px-10  min-h-screen bg-primary py-10 ">
         <div className="md:w-1/2  w-full   md:text-start text-center "  data-aos="fade-right">
         ...
         <div className="flex items-center justify-center w-full md:w-1/2 " data-aos="fade-left">
