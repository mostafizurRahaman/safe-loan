...
const CalculateImi = () => {
   ...
   const onSubmit = (data) => { 
      ...
      const emi = (loanAmount * monthlyInterestRate *(additionR / substractR)).toPrecision(5); 
         ...
         <section>
            <div className="flex items-center justify-center gap-5 md:flex-row flex-col-reverse ">
               <div className="md:w-1/2 w-full   flex items-center justify-center ">
                  <form className="text-accent capitalize  bg-primary p-5 py-14 rounded-lg flex gap-4 flex-col w-[400px]  myForm"   onSubmit={handleSubmit(onSubmit)}>
                     ...
                     <div className="flex flex-col gap-2 ">
                        ...
                        <input
                           ...
                           {...register('loanAmount', {required: "must enter loan amount" , pattern: {value: /^\d*[1-9]\d*$/, message: "loan amount must be positive" }})}
                        />
                        {
                     ...
                     <div className="flex gap-2  flex-col ">
                        ...
                        <input
                           ...
                           // max="100"
                           {
                              ...register("interestRate", {required: 'must enter an interest', pattern: {value: /^(?!00?\.00$)\d{1,2}(?:\.\d{1,2})?$/ , message: "interest between 0 to 100"} })
                           }
                        />
                        {
                     ...
                     <div className="flex gap-2  flex-col ">
                        ...
                        <input
                           ...
                           {
                              ...register('month', {required: "specify the month",  pattern: {value: /^\d*[1-9]\d*$/, message: "month must be positive" }})
                           }
                        />
                        {
