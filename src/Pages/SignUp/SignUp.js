            ...
            <div className="md:w-1/2 w-full">
               <div className="w-full  md:w-[400px] bg-primary   bg-opacity-75  p-5 rounded-lg myForm flex items-center justify-center ">
                  <form className="w-full  flex items-center flex-col gap-3 h-auto ">
                     ...
                     <div className="flex w-full  flex-col gap-1">
                        <label
                           className="flex w-full  flex-col gap-1 text-accent  "
                           htmlFor="photo"
                        >
                          
                           Photo
                        </label>
                        <label className="flex items-center justify-center gap-2 w-full border border-accent rounded-md px-5 py-4"
                           htmlFor="photo"
                        >
                           <BiImageAdd className="w-20 h-20 text-secondary"></BiImageAdd>
                           <input type="file" className="text-accent " name="photo" id="photo" />
                        </label>
                     </div>
                  </form>
               </div>
